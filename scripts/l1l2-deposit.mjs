...
// Counterpart of l2l1-withdraw.mjs: a deposit is a single L1 transaction that the
// sequencer replays on L2 within a couple of minutes — no prove/finalize acts.
//
